...
## ⚡ Handoffs activos para Codex

- **Stream Deck bridge (Corsair Galleon 100 SD):** ver [`docs/streamdeck-bridge.md`](docs/streamdeck-bridge.md). Manifest publico en `streamdeck-manifest.json` (sirve por GitHub Pages). 12 acciones cableadas al dispatcher Telegram; tu pintas las teclas y disparas `press(pageId, btnIdx)` desde tu daemon.
- **🗺️ Mapa de navegación:** [`docs/navigation-map.html`](docs/navigation-map.html) — todas las paginas / estados / verticales / overlays / sub-apps con click-through. Live en https://csilvasantin.github.io/01.-AdmiraXperience-Game/docs/navigation-map.html
